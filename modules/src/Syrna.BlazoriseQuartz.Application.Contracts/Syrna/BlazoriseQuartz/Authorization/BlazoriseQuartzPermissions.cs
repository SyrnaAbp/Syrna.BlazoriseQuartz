...
{
    public class BlazoriseQuartzPermissions
    {
        public const string GroupName = "Syrna.BlazoriseQuartz";
        ...
        {
            return ReflectionHelper.GetPublicConstantsRecursively(typeof(BlazoriseQuartzPermissions));
        }
    }
}