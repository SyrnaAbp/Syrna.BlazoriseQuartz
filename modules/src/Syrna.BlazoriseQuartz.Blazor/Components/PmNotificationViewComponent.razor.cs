...
using Syrna.BlazoriseQuartz.Blazor.Pages.BlazoriseQuartz.PrivateMessages;
...
public partial class PmNotificationViewComponent
{
    ...
    {
        Navigation.NavigateTo("/BlazoriseQuartz/PrivateMessages/PrivateMessage/Inbox");
    ...
    private string CreatePolicyName = BlazoriseQuartzPermissions.PrivateMessages.Create;
