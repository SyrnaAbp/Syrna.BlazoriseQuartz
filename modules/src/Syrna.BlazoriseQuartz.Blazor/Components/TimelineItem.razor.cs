...
namespace Syrna.BlazoriseQuartz.Blazor.Components
{
	...
	public partial class TimelineItem : BaseComponent, IDisposable
	{
		...
		{
            DotClassBuilder = new ClassBuilder(new Action<ClassBuilder>(this.BuildDotClasses));
            DotInnerClassBuilder = new ClassBuilder(new Action<ClassBuilder>(this.BuildDotInnerClasses));
