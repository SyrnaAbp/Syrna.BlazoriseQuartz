...
{
    public class ExecutionLogAppService(IExecutionLogRepository executionLogRepository) : BlazoriseQuartzAppService, IExecutionLogAppService
    {
        public async Task<PagedList<ExecutionLogDto>> GetLatestExecutionLog(string jobName, string jobGroup, string triggerName, string triggerGroup, PageMetadata pageMetadata = null, long firstLogId = 0, HashSet<LogType> logTypes = null)
        {
            ...
            {
                var list = ObjectMapper.Map<List<ExecutionLog>, List<ExecutionLogDto>>([.. query]);
            ...
            else
            {
                ...
                var result = query
                    ...
                    .ToList();
                var list = ObjectMapper.Map<List<ExecutionLog>, List<ExecutionLogDto>>([.. result]);
