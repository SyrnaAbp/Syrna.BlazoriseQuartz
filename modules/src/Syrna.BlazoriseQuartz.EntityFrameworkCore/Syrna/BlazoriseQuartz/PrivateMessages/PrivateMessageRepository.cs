...
namespace Syrna.BlazoriseQuartz.PrivateMessages
{
    ...
    public class PrivateMessageRepository : EfCoreRepository<IBlazoriseQuartzDbContext, PrivateMessage, Guid>,
        IPrivateMessageRepository
    {
        public PrivateMessageRepository(IDbContextProvider<IBlazoriseQuartzDbContext> dbContextProvider) : base(
            dbContextProvider)
        {
        }
