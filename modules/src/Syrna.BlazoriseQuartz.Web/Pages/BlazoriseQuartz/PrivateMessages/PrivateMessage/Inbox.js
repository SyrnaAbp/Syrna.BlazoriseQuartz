$(function () {
    ...
    var l = abp.localization.getResource('SyrnaBlazoriseQuartz');

    var service = syrna.blazoriseQuartz.privateMessages.privateMessage;
    var detailModal = new abp.ModalManager(abp.appPath + 'BlazoriseQuartz/PrivateMessages/PrivateMessage/DetailModal');
    var createModal = new abp.ModalManager(abp.appPath + 'BlazoriseQuartz/PrivateMessages/PrivateMessage/CreateModal');
