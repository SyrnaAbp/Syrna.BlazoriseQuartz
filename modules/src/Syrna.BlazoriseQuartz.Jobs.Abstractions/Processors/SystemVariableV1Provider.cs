using Syrna.BlazoriseQuartz.Jobs.Abstractions.Resolvers;
using Syrna.BlazoriseQuartz.Jobs.Abstractions.Resolvers.V1;

namespace Syrna.BlazoriseQuartz.Jobs.Abstractions.Processors
{
