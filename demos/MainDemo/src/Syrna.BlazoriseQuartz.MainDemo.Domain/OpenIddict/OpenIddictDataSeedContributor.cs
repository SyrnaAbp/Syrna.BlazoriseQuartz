...
namespace Syrna.BlazoriseQuartz.MainDemo.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("BlazoriseQuartz") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor
            {
                Name = "BlazoriseQuartz",
                DisplayName = "BlazoriseQuartz API",
                Resources = { "BlazoriseQuartz" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        //Web Client
        var webClientId = configurationSection["BlazoriseQuartz_Web:ClientId"];
        if (!webClientId.IsNullOrWhiteSpace())
        {
            var webClientRootUrl = configurationSection["BlazoriseQuartz_Web:RootUrl"]!.EnsureEndsWith('/');

            /* BlazoriseQuartz_Web client is only needed if you created a tiered
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["BlazoriseQuartz_Web:ClientSecret"] ?? "1q2w3e*",
        ...
        var consoleAndAngularClientId = configurationSection["BlazoriseQuartz_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["BlazoriseQuartz_App:RootUrl"]?.TrimEnd('/');
            await CreateApplicationAsync(
        ...
        // Blazor Client
        var blazorClientId = configurationSection["BlazoriseQuartz_Blazor:ClientId"];
        if (!blazorClientId.IsNullOrWhiteSpace())
        {
            var blazorRootUrl = configurationSection["BlazoriseQuartz_Blazor:RootUrl"]?.TrimEnd('/');
        ...
        var blazorServerTieredClientId = configurationSection["BlazoriseQuartz_BlazorServerTiered:ClientId"];
        if (!blazorServerTieredClientId.IsNullOrWhiteSpace())
        {
            var blazorServerTieredRootUrl = configurationSection["BlazoriseQuartz_BlazorServerTiered:RootUrl"]!.EnsureEndsWith('/');
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["BlazoriseQuartz_BlazorServerTiered:ClientSecret"] ?? "1q2w3e*",
                grantTypes: [OpenIddictConstants.GrantTypes.AuthorizationCode, OpenIddictConstants.GrantTypes.Implicit],
                scopes: commonScopes,
        ...
        var blazorWebAppTieredClientId = configurationSection["BlazoriseQuartz_BlazorWebAppTiered:ClientId"];
        if (!blazorWebAppTieredClientId.IsNullOrWhiteSpace())
        {
            var blazorWebAppTieredRootUrl = configurationSection["BlazoriseQuartz_BlazorWebAppTiered:RootUrl"]!.EnsureEndsWith('/');
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["BlazoriseQuartz_BlazorWebAppTiered:ClientSecret"] ?? "1q2w3e*",
                grantTypes: [OpenIddictConstants.GrantTypes.AuthorizationCode, OpenIddictConstants.GrantTypes.Implicit],
                scopes: commonScopes,
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["BlazoriseQuartz_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["BlazoriseQuartz_Swagger:RootUrl"]?.TrimEnd('/');
