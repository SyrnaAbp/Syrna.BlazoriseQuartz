...
using Syrna.BlazoriseQuartz.MainDemo.Blazor.Server.Host.Menus;
        ...
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            ...
            if (!hostingEnvironment.IsDevelopment())
            {
                ...
                PreConfigure<OpenIddictServerBuilder>(x =>
                {
                    ...
                    //scope: 'offline_access openid profile role email phone BlazoriseQuartz',
                    x.RegisterScopes(
        ...
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            Configure<AbpBundlingOptions>(options =>
            {
                ...
                options.StyleBundles.Configure(
                    ...
                    bundle =>
                    {
                        ...
                        bundle.AddFiles("/Syrna.BlazoriseQuartz.MainDemo.Blazor.Server.Host.styles.css");
                    }
                );
            });
            ...
            context.Services.AddAuthentication()
                .AddJwtBearer(options =>
                {
                    ...
                    options.Audience = "BlazoriseQuartz";
                });
